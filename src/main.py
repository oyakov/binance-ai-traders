...
async def main(bot: Bot, subsystem_manager: SubsystemManager) -> None:
    ...
    subsystems = [
        ...
        BinanceDataOffloadSubsystem(bot),
    ...
    bot_sub = SlaveBotSubsystem(bot, routers=[configuration_router,
                                              binance_router,
                                              new_message_router,
                                              openai_router,
                                              actuator_router])
